...
# responses + FP8 rollout only.
#   - Training: BF16 (Megatron, mbridge legacy).
#   - Rollout:  vLLM with FP8 blockwise (W:128x128 / A:1x128, e4m3, dynamic act).
#   - Dataset:  acemath_rl_4b_inst_hard (DAPO-formatted).
#   - Reward:   DAPO judge (1.0 / 0.0, overlong penalty off).
#   - Hyperparams mirror qwen3_4b_inst_acemath_colocate.sh.
set -x
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"qwen3_4b_inst_fp8rollout_acemath_colocate_16k_bsz64_mbsz32"}
